  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="bg-zinc-900 text-slate-100 hover:bg-zinc-800 hover:text-slate-200" variant="outline">Adicionar livro</Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
       ...
       <DialogHeader>
        ...
        <img src={loadingGif} alt="loading..." className="size-10 ml-[40px]"/>
       </div>
        <form onSubmit={handleSubmit(handleSubmitLibrari)} className="grid gap-4 py-4">
